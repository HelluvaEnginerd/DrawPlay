...
public class Cat {
	...
	private static final int EYE_X = HEAD_DIMENSION/2;	// adjusted
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		g2.setColor(Color.blue); //changed to blue
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
		...
		g2.drawString("Meow", catX, catY+HEAD_DIMENSION-100);	//put "meow" text above cat
	}
}
